...
public enum MCItemType {
	UNKNOWN, IRON_SHOVEL, IRON_PICKAXE, IRON_AXE, FLINT_AND_STEEL, RED_APPLE, BOW, ARROW, COAL, DIAMOND, IRON_INGOT, GOLD_INGOT, IRON_SWORD, WOODEN_SWORD, WOODEN_SHOVEL, WOODEN_PICKAXE, WOODEN_AXE, STONE_SWORD, STONE_SHOVEL, STONE_PICKAXE, STONE_AXE, DIAMOND_SWORD, DIAMOND_SHOVEL, DIAMOND_PICKAXE, DIAMOND_AXE, STICK, BOWL, MUSHROOM_SOUP, GOLD_SWORD, GOLD_SHOVEL, GOLD_PICKAXE, GOLD_AXE, STRING, FEATHER, GUNPOWDER, WOODEN_HOE, STONE_HOE, IRON_HOE, DIAMOND_HOE, GOLD_HOE, SEEDS, WHEAT, BREAD, LEATHER_CAP, LEATHER_TUNIC, LEATHER_PANTS, LEATHER_BOOTS, CHAIN_HELMET, CHAIN_CHESTPLATE, CHAIN_LEGGINGS, CHAIN_BOOTS, IRON_HELMET, IRON_CHESTPLATE, IRON_LEGGINGS, IRON_BOOTS, DIAMOND_HELMET, DIAMOND_CHESTPLATE, DIAMOND_LEGGINGS, DIAMOND_BOOTS, GOLD_HELMET, GOLD_CHESTPLATE, GOLD_LEGGINGS, GOLD_BOOTS, FLINT, RAW_PORKCHOP, COOKED_PORKCHOP, PAINTINGS, GOLDEN_APPLE, SIGN, WOODEN_DOOR, BUCKET, WATER_BUCKET, LAVA_BUCKET, MINECART, SADDLE, IRON_DOOR, REDSTONE, SNOWBALL, BOAT, LEATHER, MILK, CLAY_BRICK, CLAY, SUGAR_CANE, PAPER, BOOK, SLIMEBALL, MINECART_WITH_CHEST, MINECART_WITH_FURNACE, CHICKEN_EGG, COMPASS, FISHING_ROD, CLOCK, GLOWSTONE_DUST, RAW_FISH, COOKED_FISH, DYE, BONE, SUGAR, CAKE, BED, REDSTONE_REPEATER, COOKIE, MAP, SHEARS, MELON_SLICE, PUMPKIN_SEEDS, MELON_SEEDS, RAW_BEEF, STEAK, RAW_CHICKEN, COOKED_CHICKEN, ROTTEN_FLESH, ENDER_PEARL, BLAZE_ROD, GHAST_TEAR, GOLD_NUGGET, NETHER_WART, POTIONS, GLASS_BOTTLE, SPIDER_EYE, FERMENTED_SPIDER_EYE, BLAZE_POWDER, MAGMA_CREAM, BREWING_STAND, CAULDRON, EYE_OF_ENDER, GLISTERING_MELON, SPAWN_EGG, BOTTLE_O_ENCHANTING, FIRE_CHARGE, DISC_13, CAT_DISC, BLOCKS_DISC, CHIRP_DISC, FAR_DISC, MALL_DISC, MELLOHI_DISC, STAL_DISC, STRAD_DISC, WARD_DISC, DISC_11;
